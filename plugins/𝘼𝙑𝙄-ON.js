...
const listMessage = {
  text: '\nThis is the list of 💖Prince avi md 💖Now you can turn on and off it',
  footer: igfg,
  title: `💖Prince avi md 💖`,
...
m.reply(`
😁 *${type}* ££££ *${isEnable ? '*INSTALL*' : '*UNINSTALL*'}* ${isAll ? 'for *💖Prince avi md 💖* bot' : isUser ? '' : 'for *💖Prince avi md 💖* bot'}
`.trim()) 
