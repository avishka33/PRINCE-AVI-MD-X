...
if (!global.db.data.chats[m.chat].nsfw) throw `💖Prince avi md 💖 group doesnt supprt nsfw \n\n enable it by \n*${usedPrefix}enable* nsfw 💖Prince avi md 💖 join nsfw group https://chat.whatsapp.com/JyyF8F0Au1K9P6uaYLI6iI`
